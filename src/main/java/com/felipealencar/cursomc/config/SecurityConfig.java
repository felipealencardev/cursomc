...
import com.felipealencar.cursomc.security.JWTAuthenticationFilter;
import com.felipealencar.cursomc.security.JWTAutorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.addFilter(new JWTAutorizationFilter(authenticationManager(), jwtUtil, this.userDetailsService));
